...
// 1. Add video modal state after addSuccess state
...
// 3. Replace trailers section with compact thumbnails
const oldTrailers = `{/* Game Trailers Section */}
...
const newTrailers = `{/* Game Trailers Section - Compact Thumbnails */}
            {game.videos && game.videos.length > 0 && (
              <div>
                <h2 className="text-lg font-semibold mb-3">Trailers</h2>
...
content = content.replace(oldTrailers, newTrailers);

// 4. Add video modal before the final closing tags
const videoModal = `
        {/* Video Modal */}
        {selectedVideo && (
          <div
...
fs.writeFileSync('G:/Projects/NextUp/src/app/games/[id]/page.tsx', content);
